    ...
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="rounded-xl border border-border bg-card">
        <div className="border-b border-border px-5 py-4">
          ...
          <p className="text-xs text-muted-foreground mt-0.5">Your account information from Clerk.</p>
        </div>
          ...
          {isSignedIn && user ? (
            <>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                />
                <InfoRow icon={Shield} label="Clerk ID" value={user.id} />
                <InfoRow icon={ExternalLink} label="Provider" value={provider} />
              </div>
            </>
          ) : (
