    ...
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col justify-end px-6 pb-24 pt-32">
        ...
        <h1 className="max-w-4xl font-serif text-6xl leading-[1.05] tracking-tight md:text-8xl lg:text-[7rem]">
          ...
          <br />
          step of{" "}
          <span className="text-sage-400">your</span>
          <br />
          <span className="text-sage-400">clinical workflow.</span>
        </h1>
        ...
        <div className="mt-8">
          <p className="max-w-sm text-base leading-relaxed text-muted-foreground">
            We automate clinical workflows — from patient outreach and
            follow-ups to scheduling and referrals — so nothing falls through
            the cracks.
          </p>
        </div>
      </div>
